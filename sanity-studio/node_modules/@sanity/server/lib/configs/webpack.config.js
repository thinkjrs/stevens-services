...
var _default = function _default() {
  ...
  return {
    entry: {
      app: [resolve('normalize.css'), _path.default.join(__dirname, '..', 'browser', isProd ? 'entry.js' : 'entry-dev.js')].filter(Boolean),
    ...
    module: {
      rules: [{
        ...
        use: {
          ...
          options: babelConfig || {
            presets: [resolve('@babel/preset-typescript'), resolve('@babel/preset-react'), [resolve('@babel/preset-env'), require('./babel-env-config')]],
