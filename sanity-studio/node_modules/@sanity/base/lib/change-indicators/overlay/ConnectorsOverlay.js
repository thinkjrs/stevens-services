...
var _getElementGeometry = require("../helpers/getElementGeometry");
...
function useResizeObserver(element, onResize) {
  _react.default.useEffect(() => _resizeObserver.resizeObserver.observe(element, onResize), [element, onResize]);
}
...
var ConnectorsOverlay = /*#__PURE__*/_react.default.memo(function ConnectorsOverlay(props) {
  ...
  var enabledConnectors = changeBarsWithFocusOrHover.map((_ref) => {
    ...
    return {
      ...
      field: _objectSpread(_objectSpread({}, field), (0, _getElementGeometry.getElementGeometry)(field.element, rootRef)),
      change: _objectSpread(_objectSpread({}, change), (0, _getElementGeometry.getElementGeometry)(change.element, rootRef))
    };
  });
  ...
  return /*#__PURE__*/_react.default.createElement(_scroll.ScrollMonitor, {
    ...
    var field = _ref5.field,
        ...
        hasHover = _ref5.hasHover,
        hasRevertHover = _ref5.hasRevertHover;
    ...
    }, change && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("g", {
