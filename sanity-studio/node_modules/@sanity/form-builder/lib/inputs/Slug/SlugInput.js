...
var SlugInput = /*#__PURE__*/_react.default.forwardRef(function SlugInput(props, forwardedRef) {
  ...
  var handleFocus = _react.default.useCallback(() => onFocus(), [onFocus]);
  ...
  return /*#__PURE__*/_react.default.createElement(_ChangeIndicator.ChangeIndicatorCompareValueProvider, {
    ...
    padding: 2,
    tone: "critical"
  }, generateState.error.message)), /*#__PURE__*/_react.default.createElement(_ui.Box, {
    marginLeft: 1
    ...
    onFocus: handleFocus,
    text: (generateState === null || generateState === void 0 ? void 0 : generateState.status) === 'pending' ? 'Generating…' : 'Generate'
  }))))));
});
