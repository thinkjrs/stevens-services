...
var UrlInput = /*#__PURE__*/_react.default.forwardRef(function UrlInput(props, forwardedRef) {
  ...
  var uriRule = (0, _getValidationRule.getValidationRule)(type, 'uri');
  var inputType = uriRule && (0, _get2.default)(uriRule, 'constraint.options.allowRelative') ? 'text' : 'url';
