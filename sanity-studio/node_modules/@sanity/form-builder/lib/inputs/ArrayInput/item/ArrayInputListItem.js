...
exports.ArrayInputListItem = void 0;
...
var _ArrayInputListItem = _interopRequireDefault(require("./ArrayInputListItem.css"));
...
var DragHandle = (0, _sortable.createDragHandle)(() => /*#__PURE__*/_react.default.createElement("span", {
  className: _ArrayInputListItem.default.dragHandle
...
class ArrayInputListItem extends _react.default.PureComponent {
  constructor() {
    super(...arguments);

    _defineProperty(this, "_focusArea", void 0);

    _defineProperty(this, "innerElement", void 0);
    ...
    _defineProperty(this, "setInnerElement", el => {
  ...
  renderItem() {
    ...
    return /*#__PURE__*/_react.default.createElement(_changeIndicators.ChangeIndicatorScope, {
      ...
      className: _ArrayInputListItem.default.inner,
      ...
      className: _ArrayInputListItem.default.previewWrapper
    }, /*#__PURE__*/_react.default.createElement("div", {
      tabIndex: -1,
      ref: this.setFocusArea,
      className: _ArrayInputListItem.default.previewWrapperHelper,
      onFocus: this.handleFocus
    }, !value._key && /*#__PURE__*/_react.default.createElement("div", {
      className: _ArrayInputListItem.default.missingKeyMessage
    }, "Missing key"), /*#__PURE__*/_react.default.createElement(_Preview.default, {
      layout: "default",
      value: value,
      type: memberType
    }))), /*#__PURE__*/_react.default.createElement("div", {
      className: _ArrayInputListItem.default.functions
    }, !readOnly && /*#__PURE__*/_react.default.createElement("div", {
      className: _ArrayInputListItem.default.presenceContainer
    }, /*#__PURE__*/_react.default.createElement(_presence2.FieldPresence, {
      presence: hasItemFocus ? [] : presence,
      maxAvatars: 1
    })), !readOnly && /*#__PURE__*/_react.default.createElement("div", {
      className: _ArrayInputListItem.default.validationStatusContainer
    }, /*#__PURE__*/_react.default.createElement(_status.default, {
      markers: scopedValidation,
      showSummary: !value._ref
    })), /*#__PURE__*/_react.default.createElement("div", {
      className: _ArrayInputListItem.default.editButtonContainer
    }, value._ref && /*#__PURE__*/_react.default.createElement(_intent.default, {
      className: _ArrayInputListItem.default.linkToReference,
      ...
      className: _ArrayInputListItem.default.removeButtonContainer
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      className: _ArrayInputListItem.default.root
    }, this.renderItem(), isExpanded && this.renderEditItemForm(value));
  }

}

exports.ArrayInputListItem = ArrayInputListItem;

_defineProperty(ArrayInputListItem, "defaultProps", {
  level: 0,
  markers: []
});