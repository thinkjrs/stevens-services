...
const InnerAutocomplete = forwardRef((props, ref) => {
    ...
    const clearButton = useMemo(() => value.length > 0
        ...
        : undefined, [handleClearButtonFocus, value]);
    return (React.createElement(Root, { "data-ui": "Autocomplete", onBlur: handleRootBlur, onKeyDown: handleRootKeyDown, ref: rootRef },
        React.createElement(TextInput, Object.assign({}, restProps, { "aria-activedescendant": activeItemId, "aria-autocomplete": "list", "aria-expanded": expanded, "aria-owns": listboxId, autoCapitalize: "off", autoComplete: "off", autoCorrect: "off", border: border, clearButton: clearButton, icon: icon, id: id, inputMode: "search", onChange: handleInputChange, onClear: handleClearButtonClick, onFocus: handleInputFocus, padding: padding, radius: radius, ref: setRef, role: "combobox", fontSize: fontSize, spellCheck: false, suffix: openButton ? (React.createElement(Box, { padding: 1 },
                React.createElement(Button, { icon: ChevronDownIcon, mode: "bleed", onClick: handleOpenClick, padding: 2 }))) : undefined, value: query === null ? renderValue(value, currentOption) : query })),
        React.createElement(ListBoxContainer, { hidden: !expanded },
            React.createElement(ListBoxCard, { paddingY: 1, radius: 1, shadow: 2, tabIndex: -1, tone: "inherit" },
