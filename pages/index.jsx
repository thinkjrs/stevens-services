            ...
            <div className="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h2 className="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
                  <span className="mr-1">Hands-off maintenance </span>
                  <br className="xl:hidden" />
                  <span className="text-indigo-600">to simplify your life</span>
                </h2>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  From lawn, landscape, snow removal, industrial winterizing, to
                  interior/exterior remodeling and historical renovation, we
                  take it on.
                  {' '}
                </p>
        ...
        <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-screen-xl">
          ...
          <div className="relative">
            <h3 className="text-center text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10">
              Save your Saturday or your Monday
            </h3>
            <p className="mt-4 max-w-3xl mx-auto text-center text-xl leading-7 text-gray-500">
              Our consumer and enterprise clients get white-glove, turn-key snow
              removal, lawn care, maintenance upkeep, and renovation services.
            </p>
          </div>
          <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div className="relative">
              <h4 className="text-2xl leading-8 font-extrabold text-gray-900 tracking-tight sm:text-3xl sm:leading-9">
                Keep your sanity. Book your seasonal lawn and landscape package
                today.
              </h4>
              <p className="mt-3 text-lg leading-7 text-gray-500">
                Get ahead of your competition and schedule your seasonal package
                today. Seasonal subscriptions are only available htmlFor a
                limited time so get yours today.
              </p>
              <ul className="mt-10">
                <li>
                  <div className="flex">
                ...
                <li className="mt-10">
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-base leading-6 text-gray-500">
                        No random phone calls, regular scheduling, and you
                        control of notification frequency with our zero-spam
                        commitment.
                      </p>
                    </div>
                  </div>
                ...
                <li className="mt-10">
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      <h5 className="text-lg leading-6 font-medium text-gray-900">
                        Simple, high-quality service
                      </h5>
                      <p className="mt-2 text-base leading-6 text-gray-500">
                        Get your weekly lawn and landscape maintenance handled
          ...
          <div className="relative mt-12 sm:mt-16 lg:mt-24">
            <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
              <div className="lg:col-start-2">
                <h4 className="text-2xl leading-8 font-extrabold text-gray-900 tracking-tight sm:text-3xl sm:leading-9">
                  Conquer your hectic life
                </h4>
                <p className="mt-3 text-lg leading-7 text-gray-500">
                  Murphy's law is Murphy's law htmlFor a reason. We're here to
                  help you tame the untameable with high-touch, hands-off
                  maintenance.
                </p>
                <ul className="mt-10">
                  <li>
                    <div className="flex">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg leading-6 font-medium text-gray-900">
                          Regular maintenance, on your schedule
                        </h5>
                        <p className="mt-2 text-base leading-6 text-gray-500">
                          Change your maintenance window up to one-week prior to
                          your scheduled maintenance. You're in control.
                        </p>
                      </div>
                    </div>
                  </li>
                  <li className="mt-10">
                    <div className="flex">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-2 text-base leading-6 text-gray-500">
                          Don't do a thing. We've had this htmlFor thirteen
                          years.
                        </p>
                      </div>
                    </div>
              ...
              <div className="mt-10 -mx-4 relative lg:mt-0 lg:col-start-1">
                ...
                <img
                  className="relative mx-auto"
                  width="490"
                  src="images/IMG_2411A_yctcla.jpg"
                  alt=""
                />
              </div>
            </div>
        ...
        <div className="relative max-w-screen-xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          <div className="md:ml-auto md:w-1/2 md:pl-10">
            ...
            <p className="mt-3 text-lg leading-7 text-gray-300">
              Legendary attentiveness, striking efficiency, and a knack htmlFor
              getting it right. That's your team. That's Stevens Services.
            </p>
            <div className="mt-8">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="mt-3 max-w-2xl mx-auto text-xl leading-7 text-gray-500 sm:mt-4">
              We have happy clients and stand behind our quality work.
            </p>
          </div>
            ...
            <div className="flex flex-col rounded-lg shadow-lg overflow-hidden">
              <div className="flex-shrink-0">
                <img
                  ...
                  src="images/20201029_115456_resized_avvnx7.jpg"
                  alt=""
                />
              </div>
                ...
                <div className="flex-1">
                  ...
                  <a className="block" href="#">
                    <h3 className="mt-2 text-xl leading-7 font-semibold text-gray-900">
                      Do this summer in-style
                    </h3>
                    <p className="mt-3 text-base leading-6 text-gray-500">
                      The team knocked this one out of the park last summer.
                      When the Smiths, long-term consumer and business clients,
                      asked us to build a deck wrapped around their entire
                      house, we were stoked. What great idea and the finished
                      project provides their family...
                    </p>
                  </a>
                </div>
            ...
            <div className="relative lg:ml-10">
              ...
              <blockquote className="relative">
                <div className="text-2xl leading-9 font-medium text-gray-900">
                  <p>
                    Nothing matters more than a high-quality finished product.
                    And I'm proud to stand behind that, as the only product we
                    offer.
                  </p>
                </div>
                  ...
                  <div className="flex">
                    <div className="flex-shrink-0 lg:hidden">
                      <img
                        ...
                        width="100%"
                        src="images/bob-headshot.jpg"
                        alt="Bob Stevens, Proprietor of Stevens Services, Inc."
                      />
                    </div>
          ...
          <div className="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
            <div className="space-y-5 sm:space-y-4">
              <h2 className="text-3xl leading-9 font-extrabold tracking-tight sm:text-4xl">
                About Stevens Services
              </h2>
              <p className="text-xl leading-7 text-gray-500">
                We pride ourselves on quality, turn-key work. That means
                up-front answers and costs, a team that
                {' '}
                <em>listens</em>
                , and
                finishes
                  ...
                  <div className="space-y-4 sm:grid sm:grid-cols-3 sm:items-start sm:gap-6 sm:space-y-0">
                    <div className="relative pb-2/3 sm:pt-2/3">
                      <img
                        ...
                        src="public/images/bob-headshot.jpg"
                        height={100}
                        width={100}
                        alt="Bob Stevens, Proprietor of Stevens Services, Inc."
                      />
                    ...
                    <div className="sm:col-span-2">
                      <div className="space-y-4">
                        <div className="text-lg leading-6 font-medium space-y-1">
                          <h4>Bob Stevens</h4>
                          <p className="text-indigo-600">Proprietor</p>
                        </div>
                        <div className="text-lg leading-7">
                          <p className="text-gray-500">
                            Bob's expertise builds upon decades of experience
                            and thousands of happy clients. Bob employs a unique
                            perspective to helping clients by leveraging an
                            extensive array of know-how-been-through-it-all
                            knowledge. He's happy when the client is happy.
                          </p>
                        </div>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-lg leading-7 text-gray-500">
                You know the bidding process and hate dealing with multiple
                calls, offers, and opaque prices. So we've gotten rid of all
                that.
              </p>
              <div className="mt-8 sm:flex">
                ...
                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <a
                    ...
                    href="#"
                  >
                    See what we can take care of htmlFor you
                  </a>
                </div>
              </div>
            </div>
            <div className="mt-8 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-0 lg:grid-cols-2">
              <div className="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
                <img
                  className="max-h-12"
                  src="https://tailwindui.com/img/logos/v1/transistor-logo.svg"
                  alt=""
                />
              </div>
              <div className="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
                <img
                  className="max-h-12"
                  src="https://tailwindui.com/img/logos/v1/mirage-logo.svg"
                  alt=""
                />
              </div>
              <div className="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
              ...
              <div className="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
                <img
                  className="max-h-12"
                  src="https://tailwindui.com/img/logos/v1/laravel-logo.svg"
                  alt=""
                />
              </div>
              <div className="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
              ...
              <div className="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
                <img
                  className="max-h-12"
                  src="https://tailwindui.com/img/logos/v1/statamic-logo.svg"
                  alt=""
                />
              </div>
            </div>
                  ...
                  <div className="mt-4 grid grid-cols-1 gap-y-4">
                    <div className="flex items-center">
                      <input
                        ...
                        type="radio"
                      />
                      <label className="ml-3" htmlFor="budget_under_25k">
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        type="radio"
                      />
                      <label className="ml-3" htmlFor="budget_25k-50k">
                        <span className="block text-sm text-gray-700">
                          $1K &ndash; $5K
                        </span>
                      </label>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        type="radio"
                      />
                      <label className="ml-3" htmlFor="budget_50k-100k">
                        <span className="block text-sm text-gray-700">
                          $5K &ndash; $25K
                        </span>
                      </label>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        type="radio"
                      />
                      <label className="ml-3" htmlFor="budget_over_100k">
                        <span className="block text-sm text-gray-700">
                          $25K+
                        </span>
                      </label>
        ...
        <div className="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="xl:col-span-1">
              ...
              <p className="mt-8 text-gray-500 text-base leading-6">
                Making the world a better place one happy client at a time.
              </p>
              <div className="mt-8 flex">
                ...
                <a className="ml-6 text-gray-400 hover:text-gray-500" href="#">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-base leading-6 text-gray-400 xl:text-center">
              &copy; 2021 Stevens Services, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </div>
